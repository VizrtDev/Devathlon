package com.github.vizrtdev.witchhunter.database;
...
public class UserDAOJDBC implements UserDAO {
    private static final String SQL_FIND_BY_ID =
            "SELECT id, name, playedGames, recoveredGames FROM User WHERE id = ?";
    private static final String SQL_LIST_ORDER_BY_ID =
            "SELECT id, name, playedGames, recoveredGames FROM User ORDER BY id";
    private static final String SQL_INSERT =
            "INSERT INTO User (id, name, playedGames, recoveredGames) VALUES (?, ?, ?, ?)";
    private static final String SQL_UPDATE =
            "UPDATE User SET id = ?, name = ?, playedGames = ?, recoveredGames = ? WHERE id = ?";
    ...
    private static User map(ResultSet resultSet) throws SQLException {
        ...
        user.setPlayedGames( resultSet.getInt( "playedGames" ) );
        user.setRecoveredGames( resultSet.getInt( "recoveredGames" ) );
        return user;
    }
